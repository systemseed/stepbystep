...
User documentation can be found in the [`docs/`](https://github.com/systemseed/stepbystep/tree/9.x/docs) folder.
...
find up-to-date list in [composer.json of the template project](https://github.com/systemseed/stepbystep-project/blob/9.x/composer.json).
